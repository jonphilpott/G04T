...
goat_instruction instructions[] = {
     ...
     {12,  1,      "INC  A,",       1,       1,        &goat_instr_inc_a           },
     {13,  1,      "INC  B,",       1,       1,        &goat_instr_inc_b           },
     {14,  1,      "INC  [B]",      1,       1,        &goat_instr_inc_indr_b      },
     {15,  1,      "SHL  A,",       0,       1,        &goat_instr_shl_a           },
     {16,  1,      "SHR  A,",       0,       1,        &goat_instr_shr_a           },
     {17,  2,      "JMP ",          1,       1,        &goat_instr_jmp             },
     {18,  2,      "JZ  ",          1,       1,        &goat_instr_jz              },
     {19,  2,      "JNZ ",          1,       1,        &goat_instr_jnz             },
     {20,  3,      "DJNZ",          1,       1,        &goat_instr_djnz            },
     {21,  1,      "AND  A, B",     0,       0,        &goat_instr_and_a_b         },
     {22,  1,      "OR   A, B",     0,       0,        &goat_instr_or_a_b          },
     {23,  1,      "XOR  A, B",     0,       0,        &goat_instr_xor_a_b         },
     {24,  1,      "NEG  A",        0,       0,        &goat_instr_neg_a           },
     {25,  1,      "NOT  A",        0,       0,        &goat_instr_not_a           },
     {26,  1,      "IN   A",        0,       0,        &goat_instr_in_a            },
     {27,  1,      "OUT  A,",       0,       1,        &goat_instr_out_a           }
};

/* will break if this is wrong */
unsigned int n_instructions = 27;
